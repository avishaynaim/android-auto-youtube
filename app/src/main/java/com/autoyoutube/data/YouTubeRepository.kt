...
class YouTubeRepository(private val context: Context) {
    ...
    companion object {
        ...
        private val DEMO_PLAYLISTS = listOf(
            ...
            Playlist("PL3x7Z7x7x7x7x7x7x7x7x7x7x7", "Tech Reviews", 15, "Tech reviews and tutorials"),
            Playlist("PL4x4x4x4x4x4x4x4x4x4x4x4", "Podcasts", 50, "Podcasts to listen to")
        )
    }

    // ========== SYNCHRONOUS METHODS FOR MEDIA BROWSER SERVICE ==========
    
    /**
     * Get home content synchronously (for MediaBrowserService)
     */
    fun getHomeContentSync(): List<MediaBrowser.MediaItem> {
     ...
     */
    fun getTrendingContentSync(): List<MediaBrowser.MediaItem> {
     ...
     */
    fun getPlaylistsSync(): List<MediaBrowser.MediaItem> {
     ...
     * Returns sample audio URLs for demo purposes
     */
    ...
    suspend fun getVideoDetails(videoId: String): Video? = withContext(Dispatchers.IO) {
        DEMO_VIDEOS.find { it.id == videoId }
    }
    ...
    /**
     * Check if user is authenticated (always false in demo mode)
     */
